package org.fisher.weixin.service.impl;
...
import org.fisher.weixin.inmessage.ResponseError;
import org.fisher.weixin.inmessage.ResponseMessage;
import org.fisher.weixin.inmessage.ResponseToken;
import org.fisher.weixin.service.AccessTokenManager;
...
public class AccessTokenManagerSample implements AccessTokenManager {
	...
	private ResponseToken getRemoteToken(String account) {
		...
		String appid = "wx1c104665619f7d06";
		String appSecret = "b68901b78efb0cf5e006e7d7fb55c567";
