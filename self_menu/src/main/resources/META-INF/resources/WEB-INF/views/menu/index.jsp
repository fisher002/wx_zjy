...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/zjy/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/zjy/menu/js/jquery.js"></script>
<script type="text/javascript" src="/zjy/menu/js/vue.js"></script>
<script type="text/javascript" src="/zjy/menu/js/menu.js"></script>
