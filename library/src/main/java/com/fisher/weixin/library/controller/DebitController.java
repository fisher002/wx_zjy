package com.fisher.weixin.library.controller;
...
@Controller
@RequestMapping("/zjy/library/debit")
...
public class DebitController {
	...
	public String add(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/zjy/library/debit/list";
	}

	@RequestMapping("list")
	public String list() {
		return "/WEB-INF/views/library/list.jsp";
	}
